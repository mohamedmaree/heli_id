                                ...
                                @endforeach
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="icon" value="{{ $service->icon }}"   class="form-control" placeholder="{{__('admin.enter_the_icon')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}" >
                                            </div>
                                        </div>
                                    </div>
