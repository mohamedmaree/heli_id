...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin/app-assets/css-rtl/pages/error.css')); ?>">
    <!-- END: Page CSS-->
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="<?php echo e($settings['logo']); ?>" class="img-fluid align-self-center" alt="branding logo">
                                    <h1 class="font-large-2 my-1"><?php echo e(__('admin.404_the_page_does_not_exist')); ?></h1>
                                    
                                    <a class="btn btn-primary btn-lg mt-2" href="<?php echo e(url('admin/dashboard')); ?>"><?php echo e(__('admin.back_to_home_page')); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
</html><?php /**PATH /Users/mohmmedmaree/Desktop/projects/heli_id/resources/views/errors/404.blade.php ENDPATH**/ ?>