        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form  method="POST" action="<?php echo e(route('admin.teams.update' , ['id' => $team->id])); ?>" class="store form-horizontal" novalidate>
                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade <?php if($loop->first): ?> show active <?php endif; ?> " id="first_<?php echo e($lang); ?>" aria-labelledby="first_<?php echo e($lang); ?>" aria-expanded="true">
                                                        <div class="col-md-12 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" value="<?php echo e($team->getTranslations('name')[$lang]??''); ?>" name="name[<?php echo e($lang); ?>]" class="form-control" placeholder="<?php echo e(__('admin.write') . __('admin.name')); ?> <?php echo e($lang); ?>" required data-validation-required-message="<?php echo e(__('admin.this_field_is_required')); ?>" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" value="<?php echo e($team->getTranslations('job')[$lang]??''); ?>" name="job[<?php echo e($lang); ?>]" class="form-control" placeholder="<?php echo e(__('admin.write') . __('admin.job')); ?> <?php echo e($lang); ?>" required data-validation-required-message="<?php echo e(__('admin.this_field_is_required')); ?>" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohmmedmaree/Desktop/projects/heli_id/resources/views/admin/teams/edit.blade.php ENDPATH**/ ?>