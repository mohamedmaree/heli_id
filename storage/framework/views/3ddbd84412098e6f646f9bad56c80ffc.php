...
<?php $component = App\View\Components\Admin\Table::resolve(['datefilter' => 'true','order' => 'true','extrabuttons' => 'true','addbutton' => ''.e(route('admin.portfoliocategories.create')).'','deletebutton' => ''.e(route('admin.portfoliocategories.deleteAll')).'','searchArray' => [
        'name' => [
            'input_type' => 'text' , 
...
<?php $__env->startSection('js'); ?>
    ...
    <?php echo $__env->make('admin.shared.filter_js' , [ 'index_route' => url('admin/portfoliocategories')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohmmedmaree/Desktop/projects/heli_id/resources/views/admin/portfoliocategories/index.blade.php ENDPATH**/ ?>