                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    ...
                                                                    <textarea class="form-control" name="description[<?php echo e($lang); ?>]" id="" cols="30" rows="10" placeholder="<?php echo e(__('admin.write') . __('admin.description')); ?> <?php echo e($lang); ?> "></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
