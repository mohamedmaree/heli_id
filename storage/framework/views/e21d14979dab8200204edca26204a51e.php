  ...
  $(document).ready(function() {
    $(document).on('click', '.submit_button', function(e) {
      const requiredInputs = $('.store input[required]');
            ...
            if(empltyLang){
              if(empltyLang == 'ar'){
                alert("<?php echo e(__('admin.complete_ar_fields')); ?>")
              }else{
                alert("<?php echo e(__('admin.complete_en_fields')); ?>")
              }
            }
    });
    $(document).on('submit', '.store', function(e) {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $(".submit_button").html("<?php echo e(__('admin.add')); ?>").attr(
            'disable', false)
            if (response.key == 'fail') {
                ...
                Swal.fire({
                  position: 'top-start',
                  type: 'success',
                  title: '<?php echo e(__('admin.added_successfully')); ?>',
        ...
        error: function(xhr) {
          $(".submit_button").html("<?php echo e(__('admin.add')); ?>").attr('disable', false)
          $(".text-danger").remove()
          $('.store input').removeClass('border-danger')
...
<?php /**PATH /Users/mohmmedmaree/Desktop/projects/heli_id/resources/views/admin/shared/submitAddForm.blade.php ENDPATH**/ ?>