...
<?php $component = App\View\Components\Admin\Table::resolve(['datefilter' => 'true','order' => 'true','extrabuttons' => 'true','addbutton' => ''.e(route('admin.portfolios.create')).'','deletebutton' => ''.e(route('admin.portfolios.deleteAll')).'','searchArray' => [
        'client' => [
            'input_type' => 'text' , 
        ...
        'date' => [
            'input_type' => 'text' , 
            'input_name' => __('admin.date') , 
        ] ,
        'portfolio_category_id' => [
            'input_type' => 'select' , 
            'rows'       => $categories , 
            'input_name' => __('admin.portfoliocategories') , 
        ] ,
...
<?php $__env->startSection('js'); ?>
    ...
    <?php echo $__env->make('admin.shared.filter_js' , [ 'index_route' => url('admin/portfolios')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohmmedmaree/Desktop/projects/heli_id/resources/views/admin/portfolios/index.blade.php ENDPATH**/ ?>