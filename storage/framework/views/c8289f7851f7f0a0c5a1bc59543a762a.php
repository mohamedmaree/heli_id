...
<?php $component = App\View\Components\Admin\Table::resolve(['datefilter' => 'true','order' => 'true','addbutton' => ''.e(route('admin.introhowworks.create')).'','deletebutton' => ''.e(route('admin.introhowworks.deleteAll')).'','searchArray' => [
        'title' => [
            'input_type' => 'text' , 
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('admin/app-assets/js/scripts/extensions/sweet-alerts.js')); ?>"></script>
        ...
        <?php echo $__env->make('admin.shared.filter_js' , [ 'index_route' => url('admin/introhowworks')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohmmedmaree/Desktop/projects/heli_id/resources/views/admin/introhowworks/index.blade.php ENDPATH**/ ?>